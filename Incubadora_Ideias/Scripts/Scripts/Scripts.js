...
$(document).ready(function () {
    ...
    $("#tb_fi_user").fileinput({
        language: "pt",

        initialPreview: ['<img src="/Content/Images/User.png" class="file-preview-image">'],
    ...
    $("#badge_convite").popover({ html: true })
    ...
    $('#lb_covit').selectize({
        ...
        onChange: function (value) {
            $('#lb_covit').attr("data-selected", value);
        }
    });
...
function selecttab() {
    $('#ul_tabs a[href="#ideias_tab"]').tab('show')
};

$(document).ready(function () {
    $('#testeburon').click(function () {
        $('#ul_tabs a[href="#ideias_tab"]').tab('show')
    });
});
