...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <div class="form-horizontal">
        ...
        <div class="form-group">
            <label class="control-label col-sm-2" for="email" runat="server">Nome</label>
        ...
        <div class="form-group">
            ...
            <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                ...
                <asp:ListBox runat="server" data-selected="" SelectionMode="Multiple" ID="lb_covit" name="state[]" class="demo-default" ClientIDMode="Static" DataSourceID="sql_user" DataTextField="Email" DataValueField="Email"></asp:ListBox>
